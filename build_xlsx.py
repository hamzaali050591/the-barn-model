...
NON_UTIL = [
    ("Marketing", [("Social media content creation", 800),
                   ("Paid social (IG, FB, TikTok)", 1200),
                   ("Event promotion / print / signage", 500),
                   ("App marketing / push notifications", 300),
                   ("Influencer / blogger activations", 200)]),
    ("Cleaning", [("2 staff splitting 84 hrs/wk", 5000),
...
notes = [
    ...
    "  Debt Schedule    — per-location amortization (level monthly P&I to zero balance at exit)",
...
setw(ws, [22] + [13]*7)
ws['A1'] = "DEBT SCHEDULE — per location, fully amortizing to zero at exit"; ws['A1'].font = Font(bold=True, size=12, color="5C4033")
