...
function App() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Header */}
      <header className="bg-walnut text-cream py-5 md:py-6 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
              The Barn
            </h1>
            <p className="text-cream/70 text-sm md:text-base mt-0.5">
      ...
      <footer className="bg-walnut/5 border-t border-walnut/10 py-6 px-4 mt-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-walnut-light text-xs mt-2 max-w-xl mx-auto">
            ...
            that may not reflect actual results. Past performance does not guarantee future returns.
          </p>
        </div>
      </footer>
    </div>
